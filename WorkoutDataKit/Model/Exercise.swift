...
//        case png
    ...
    public init(from decoder: Decoder) throws {
        ...
        let video = try container.decodeIfPresent([String].self, forKey: .video) ?? []
        
        self.init(uuid: uuid, everkineticId: id, title: title, alias: alias, description: primer, primaryMuscle: primary, secondaryMuscle: secondary, equipment: equipment, steps: steps, tips: tips, references: references, pdfPaths: pdf,video: video)
    }
