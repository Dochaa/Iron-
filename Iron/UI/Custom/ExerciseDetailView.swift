...
//                HStack {
//                    ForEach(exercise.video, id: \.self) { video in
//                        if let videoURL = Bundle.main.path(forResource: video, ofType: "mp4") {
//                            let player = AVPlayer(url: videoURL)
//                            VideoPlayer(player: player)
//                                .frame(width: geometry.size.width, height: 300)
//                        } else {
//                            Text("\(video)")
////                            Text("Video not found: \(video)")
...
//        
//        Section(header: Text("Video")) {
//            if !self.exercise.video.isEmpty {
//                // Assuming you have only one video URL, otherwise, you may need to adjust this part
//                if let videoURL = URL(string: self.exercise.video[0]) {
...
//        Section(header: Text("Video")) {
//            HTMLWebView(htmlString: "<iframe width=\"100%\" height=\"100%\" src=\"https://www.youtube.com/embed/XstIT_dY6eE?si=KTKuC_39f2sDpvXC\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe>")
//                .frame(height: 315) // ปรับความสูงตามที่ต้องการ
//        }
//    }


    
    private func exerciseMediaURLs() -> [URL] {
        return exercise.video.compactMap { URL(string: $0) }
    }
...
//                self.videoSection
                ...
                if !self.exercise.video.isEmpty {
                    self.videoSection(geometry: geometry)
                }
